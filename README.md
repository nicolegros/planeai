...
- **Jira connection** — bundled Jira plugin with PKCE OAuth, plugin-scoped source settings, manual source sync, and a dedicated sidebar section; assignment, writeback, and periodic sync follow in later slices
