<script lang="ts">
  ...
  let { projectName, sessionName, sidebarVisible, tabs, activeTabIndex, activeTabId, prUrl, prState, ciStatus, hasChanges, sessionId, symphonyStatus, runningCount, activeProvider, onSelectTab, onCloseTab, onAddTab, onCreatePr, onOpenCommand, onTogglePrPanel, titlebarContributions = [], titlebarSession, onOpenTitlebarContribution }: Props = $props();
