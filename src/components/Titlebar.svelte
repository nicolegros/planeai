<script lang="ts">
  ...
  let { projectName, sessionName, sidebarVisible }: Props = $props();
</script>

<header
  data-tauri-drag-region
  class="h-10 flex items-center pl-20 shrink-0 bg-surface-100 dark:bg-surface-900 border-b border-surface-200 dark:border-surface-800"
>
