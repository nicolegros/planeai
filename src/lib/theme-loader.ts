...
export const DEFAULT_THEME_CSS = `:root {
  ...
  --color-primary-50: hsl(204 94% 94%);
  --color-primary-100: hsl(204 90% 86%);
  --color-primary-200: hsl(204 85% 75%);
  --color-primary-300: hsl(204 80% 63%);
  --color-primary-400: hsl(204 75% 52%);
  --color-primary-500: hsl(204 70% 42%);
  --color-primary-600: hsl(204 70% 34%);
  --color-primary-700: hsl(204 70% 26%);
  --color-primary-800: hsl(204 70% 20%);
  --color-primary-900: hsl(204 80% 16%);
  --color-primary-950: hsl(204 85% 10%);
